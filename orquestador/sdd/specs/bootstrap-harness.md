...
Luego actualizar `PROJECT_BINDING.yaml` a `binding_mode: bound`, `harness_version: "0.8.10"`, `project_root`, `project_name`, `repo_remote`, `bound_at` y `harness_instance_id`.
