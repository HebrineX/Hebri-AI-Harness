...
require_grep "install-claude-hooks requires exactly one mode" "$ROOT/scripts/install-claude-hooks.ps1" "install-claude-hooks.ps1 debe exigir modo exclusivo CheckOnly/Apply"
require_grep "permissionDecision" "$ROOT/scripts/claude-pretooluse-hook.ps1" "claude-pretooluse-hook.ps1 debe emitir permission decisions"
