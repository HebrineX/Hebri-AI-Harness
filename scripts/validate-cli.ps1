...
$StableCommands = @('help','status','budget','preflight','validate','audit','migrate','bootstrap','update-bound','list-bound-backups','restore-bound','command')
...
Assert-Contains 'scripts/hebrinex.ps1' 'cli_contract_version=0[.]1' 'CLI help must expose contract version marker'
...
Assert-OutputContains $help 'cli_contract_version=0[.]1' 'help output must include contract version'
