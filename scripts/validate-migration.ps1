...
Assert-Contains 'orquestador/migration/contracts/post-migration-contract.yaml' 'target_version:\s*"0[.]15[.]0"' 'post migration template must target 0.15.0'
...
if ($RequireApplied -or ($currentHarnessVersion -match '^0[.](10|11|12|13|14|15)[.][0-9]+$' -and $bindingMode -eq 'bound')) {
...
elseif ($currentHarnessVersion -notmatch '^0[.](10|11|12|13|14|15)[.][0-9]+$') {
