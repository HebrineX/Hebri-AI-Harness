...
Assert-Contains 'orquestador/harness-manifest.txt' 'orquestador/method/cli-contract.md' 'CLI contract must be in manifest'
...
Assert-Contains 'orquestador/harness-manifest.txt' 'scripts/validate-cli.ps1' 'validate-cli.ps1 must be in manifest'
...
Assert-Contains 'scripts/validate-bound-update.ps1' 'Bound update validation OK' 'validate-bound-update.ps1 must expose success marker'
Assert-Contains 'scripts/validate-bound-backups.ps1' 'Bound backup inventory validation OK' 'validate-bound-backups.ps1 must expose success marker'
